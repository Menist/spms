  ...
  return (
    <main>
      ...
      <p style={{marginTop: "20px"}}>
        ...
        Благодарим за интерес к услугам компании IMC COMPUTERS. На основании обсуждения требований подготовлено предварительное коммерческое предложение на разработку сайта. Ниже представлен состав работ, ориентировочная трудоёмкость и стоимость проекта.
      </p>
